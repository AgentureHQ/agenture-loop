...
Not implemented. Superseded on 2026-05-27 by the redefinition of epic `taskman_python`. Intent unchanged; the new model adds a nested-tree rendering and operates on stable item-IDs. Successor feature: `web_ui`. See `tasks/epics/20260525_taskman_python.md`.
